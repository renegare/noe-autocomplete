...
+function (root, jasmine, $) {
  ...
  jasmine.Env.prototype.describeComponent = function (componentReference, specDefinitions) {
    describe(componentReference.toString(), describeComponentFactory(componentReference, specDefinitions));
  };
  ...
  jasmine.Env.prototype.ddescribeComponent = function (componentReference, specDefinitions) {
    ddescribe(componentReference.toString(), describeComponentFactory(componentReference, specDefinitions));
  };
  ...
  jasmine.Env.prototype.describeMixin = function (mixinReference, specDefinitions) {
    describe(mixinReference.toString(), describeMixinFactory(mixinReference, specDefinitions));
  };
  ...
  jasmine.Env.prototype.ddescribeMixin = function (mixinReference, specDefinitions) {
    ddescribe(mixinReference.toString(), describeMixinFactory(mixinReference, specDefinitions));
  };
  ...
  jasmine.Env.prototype.describeModule = function (moduleReference, specDefinitions) {
    describe(moduleReference.toString(), describeModuleFactory(moduleReference, specDefinitions));
  };
  ...
  jasmine.Env.prototype.ddescribeModule = function (moduleReference, specDefinitions) {
    ddescribe(moduleReference.toString(), describeModuleFactory(moduleReference, specDefinitions));
  };
