    ...
    this.after('initialize', function() {
        ...
        this.on('keydown', {
            inputSelector: function(e) {
                if(e.keyCode === 38) {
                    e.preventDefault();
                } else if (e.keyCode === 13 && this.suggestionIndex > -1){
                    e.preventDefault();
                    e.stopPropagation();
                    this.trigger(this.attr.events.uiSelectedSuggestion, this.suggestions[this.suggestionIndex]);
                } else if([13, 38,40].indexOf(e.keyCode) === -1) {
                    this.getSuggestions();
                }
            }
        });
